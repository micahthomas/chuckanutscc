...
-- Photographers
-- ---------------------------------------------------------------------------
INSERT INTO photographers (id, slug, name, bio_md, portfolio_url, instagram_url, contact_email, active, created_at, updated_at) VALUES
  ('photog_alice', 'alice-chen', 'Alice Chen',
   ...
   'alice@example.com', 1, unixepoch(), unixepoch()),
  ...
  ('photog_bob', 'bob-martinez', 'Bob Martinez',
   ...
   'bob@example.com', 1, unixepoch(), unixepoch()),
  ...
  ('photog_peter', 'peter-zuidmeer', 'Peter Zuidmeer',
   ...
   NULL, NULL, NULL, 1, unixepoch(), unixepoch());
...
-- ---------------------------------------------------------------------------
INSERT INTO event_photographers (id, event_id, photographer_id, drive_folder_url, notes, created_at) VALUES
  ('ep_cup1_a',     'evt_cup1', 'photog_alice', 'https://drive.google.com/drive/folders/cup1-alice', 'Action shots from grid',   unixepoch()),
  ('ep_cup1_b',     'evt_cup1', 'photog_bob',   'https://drive.google.com/drive/folders/cup1-bob',   'Course corners',           unixepoch()),
  ('ep_cup2_a',     'evt_cup2', 'photog_alice', 'https://drive.google.com/drive/folders/cup2-alice', NULL,                       unixepoch()),
  ('ep_cup2_photog_peter', 'evt_cup2', 'photog_peter', 'https://facebook.com/peters-cup2-2026',      'Full grid album',          unixepoch()),
  ('ep_cup3_b',     'evt_cup3', 'photog_bob',   'https://drive.google.com/drive/folders/cup3-bob',   'Assigned, awaiting event', unixepoch()),
  ('ep_cup5_a',     'evt_cup5', 'photog_alice', 'https://drive.google.com/drive/folders/cup5-alice', NULL,                       unixepoch());
