...
DELETE FROM events;
-- Pages are not wiped: migration 0009 seeds page_autocross_rules and would
-- be undone by a DELETE here. The INSERTs below use OR REPLACE so re-seeds
-- still refresh page_about / page_rules.
...
-- Pages
-- ---------------------------------------------------------------------------
INSERT OR REPLACE INTO pages (id, slug, title, body_md, show_in_nav, nav_order, created_at, updated_at, updated_by) VALUES
